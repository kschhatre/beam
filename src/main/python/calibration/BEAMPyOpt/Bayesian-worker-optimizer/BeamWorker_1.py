...
class BeamWorker(Worker):
    ...
    def compute(self, config, budget, **kwargs):
        ...
        Repo='/home/ubuntu/ksc_test/beam/'
        Current='/home/ubuntu/ksc_test/beam-calibration-dev/TUNE_integrate/TUNE_test'
        with open('/home/ubuntu/ksc_test/HpBandSter/hpbandster/core/timer.txt') as f:
        ...
        def all_subdirs_of(b='/home/ubuntu/ksc_test/beam/output/'+selected_sim+'/'):
            result = []
        ...
        # Get config ID value
        log_inf = hpres.logged_results_to_HBS_result('/home/ubuntu/ksc_test/beam-calibration-dev/TUNE_integrate/TUNE_test/worker_n_optimizer/')
